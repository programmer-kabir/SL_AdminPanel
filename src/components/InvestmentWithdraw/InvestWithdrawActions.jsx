...
<body>
  ...
  <div class="page">
    <div class="content">
      ...
      <div class="title">বিনিয়োগের আগাম সমাপ্তির আবেদনপত্র</div>
      ...
      <p>
        অতএব, বিনীত প্রার্থনা এই যে, আমার বিনিয়োগের সময়কাল ও Weighted Value বিবেচনা করে
        আমার মূলধন এবং অর্জিত লভ্যাংশ (প্রযোজ্য ক্ষেত্রে) দ্রুত বুঝিয়ে দেওয়ার জন্য প্রয়োজনীয় ব্যবস্থা
        গ্রহণ করলে আমি কৃতজ্ঞ থাকব।
      </p>
